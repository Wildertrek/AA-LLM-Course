...
# -----------------------------------------------------------------------------
# Updated Follow-up Questions Function (using dynamic OpenAI client)
# -----------------------------------------------------------------------------
def generate_follow_up_queries(prompt: str, response: str, llm_params: dict, selected_model: str, api_key: str):
    ...
    try:
        ...
        # Initialize a dynamic OpenAI client with the selected model
...
if submit_button and user_input:
    ...
    # Generate follow-up queries using the selected model if OpenAI Dynamic is chosen.
