...
def generate_follow_up_queries(prompt: str, response: str, llm_params: dict, selected_model: str, api_key: str):
    ...
    try:
        ...
        # Initialize a new OpenAI client with the selected model for follow-up queries
...
# slider label for web search referenced responses
num_references = st.sidebar.slider(
    "Web Search Number of Referenced Responses Desired", 1, 5, 5, help="Specify how many referenced responses you want to retrieve from web search/RAG."
)
...
# -----------------------------------------------------------------------------
st.title("AI Assistant with Dynamic Model Loading")
...
if submit_button and user_input:
    ...
    try:
        ...
        if llm_provider == "OpenAI Dynamic":
            ...
            final_max = max_tokens_slider  # Use slider value directly
