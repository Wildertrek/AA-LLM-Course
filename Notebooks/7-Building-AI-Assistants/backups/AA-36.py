...
def openai_chat_completion(messages, model, temperature, top_p, max_tokens, api_key):
    """
    Manually map SystemMessage/HumanMessage to correct "role".
    """
    ...
    for m in messages:
        if isinstance(m, SystemMessage):
            ...
            # e.g. an AssistantMessage or custom
...
# Dynamically load embedding models from metadata
...
if st.sidebar.button("Process Files", help="Embed and index uploaded files."):
    ...
    for uploaded_file in uploaded_files:
        ...
        # Insert your actual embedding or indexing logic here, using `embedding_id`.
    st.sidebar.success("Files processed and indexed.")

# -----------------------------------------------------------------------------
# Main Query Section
# -----------------------------------------------------------------------------
st.title("AI Assistant (Chat + RAG Pipeline)")
